...
export type InferType = "relation" | "array" | "object" | "date" | "email" | "image" | "url" | "richtext" | "text" | "number" | "boolean" | "unknown" | `custom_${string}` | null;
...
export type FieldInferencer = (key: string, value: unknown, record: Record<string, unknown>, infer: FieldInferencer, type?: "list" | "show" | "edit" | "create") => InferField | null | false;
export type FieldTransformer = (fields: Array<InferField>, resources: IResourceItem[], resource: IResourceItem, record: Record<string, unknown>, infer: FieldInferencer, type: "list" | "show" | "edit" | "create") => Array<InferField>;
...
export type InferencerComponentProps = {
    ...
    meta?: {
        [resourceIdentifierOrName: string]: {
            [key in keyof Pick<DataProvider, "getList" | "getMany" | "getOne" | "update" | "create"> | "default"]?: Record<string, any>;
        };
    };
    /**
...
export type CreateInferencer = (config: CreateInferencerConfig) => InferencerResultComponent;
