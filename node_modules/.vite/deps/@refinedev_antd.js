...
import {
  ...
  z,
  zu
} from "./chunk-PJL2D6V2.js";
import {
  baseGetTag_default,
  isObjectLike_default,
  isObject_default,
  root_default
} from "./chunk-OQGFEMQR.js";
import {
  require_react_dom
...
var require_unist_util_position = __commonJS({
  "node_modules/unist-util-position/index.js"(exports2, module2) {
    "use strict";
...
var he2 = o2(({ action: e2, resource: t, onMutationSuccess: r, onMutationError: s, autoSave: n2, submitOnEnter: i = false, warnWhenUnsavedChanges: a, redirect: p, successNotification: l, errorNotification: m, meta: u, metaData: d, queryMeta: c, mutationMeta: f, liveMode: h, liveParams: y, mutationMode: g, dataProviderName: b, onLiveEvent: P, invalidates: B, undoableTimeout: C, queryOptions: S, createMutationOptions: k, updateMutationOptions: F, id: D, overtimeOptions: T, optimisticUpdateMap: v, defaultFormValues: U, disableServerSideValidation: H = false } = {}) => {
  var _, fe;
  let { options: j } = ge(), x = (j == null ? void 0 : j.disableServerSideValidation) || H, K = z(), [$] = form_default.useForm(), A = useForm({ form: $, defaultFormValues: U }), { form: E } = A, q2 = RP({ onMutationSuccess: r || void 0, onMutationError: async (Z, ee, le) => {
    if (x) {
      s == null || s(Z, ee, le);
      return;
    }
    ...
    E.setFields([...ie2]), s == null || s(Z, ee, le);
  }, redirect: p, action: e2, resource: t, successNotification: l, errorNotification: m, meta: I(u, d), metaData: I(u, d), queryMeta: c, mutationMeta: f, liveMode: h, liveParams: y, mutationMode: g, dataProviderName: b, onLiveEvent: P, invalidates: B, undoableTimeout: C, queryOptions: S, createMutationOptions: k, updateMutationOptions: F, id: D, overtimeOptions: T, optimisticUpdateMap: v, autoSave: n2 }), { formLoading: L, onFinish: O, query: M, id: Y, onFinishAutoSave: N } = q2, { warnWhenUnsavedChanges: z2, setWarnWhen: w } = vt(), R = a ?? z2;
  ...
  let J = o2((Z) => {
    ...
    return Z;
  }, "onValuesChange"), se = { disabled: L, onClick: () => {
    E.submit();
  } };
  return { form: A.form, formProps: { ...A.formProps, onFinish: (Z) => O(Z).catch((ee) => ee), onKeyUp: J, onValuesChange: X, initialValues: (fe = M == null ? void 0 : M.data) == null ? void 0 : fe.data }, saveButtonProps: se, defaultFormValuesLoading: A.defaultFormValuesLoading, ...q2, onFinish: async (Z) => await O(Z ?? A.form.getFieldsValue(true)) };
}, "useForm");
...
var ro = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  var z2, w;
  let [p, l] = import_react77.default.useState(false), m = Ae(), { resource: u, action: d, identifier: c } = q(a.resource), f = Te(), h = Pe(), y = ht(), g = a.action ?? d ?? "", b = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), P = typeof e2 == "object" && "key" in e2 ? e2.key : u && g && e2 ? `modal-${c}-${g}` : void 0, B = he2({ meta: { ...P ? { [P]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: C, formProps: S, id: k, setId: F, formLoading: D, onFinish: T, autoSaveProps: v } = B, U = z(), { warnWhen: H, setWarnWhen: j } = vt(), { show: x, close: K, modalProps: $ } = to2({ modalProps: { open: t } }), A = $.open || false, E = { modalProps: $, form: C, formLoading: D, formProps: S, formResult: void 0, formValues: C.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: T, close: K, open: $.open || false, show: x, visible: A };
  import_react77.default.useEffect(() => {
    var R, J, X, se;
    if (p === false && P) {
      let _ = (J = (R = f == null ? void 0 : f.params) == null ? void 0 : R[P]) == null ? void 0 : J.open;
      if (typeof _ == "boolean" ? _ && x() : typeof _ == "string" && _ === "true" && x(), b) {
        let fe = (se = (X = f == null ? void 0 : f.params) == null ? void 0 : X[P]) == null ? void 0 : se.id;
        fe && (F == null || F(fe));
      }
      l(true);
    }
  }, [P, f, b, F]), import_react77.default.useEffect(() => {
    var R;
    p === true && (A && P ? h({ query: { [P]: { ...(R = f == null ? void 0 : f.params) == null ? void 0 : R[P], open: true, ...b && k && { id: k } } }, options: { keepQuery: true }, type: "replace" }) : P && !A && h({ query: { [P]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [k, A, x, P, b]);
  let q2 = { disabled: D, loading: D, onClick: () => {
    C.submit();
  } }, L = (0, import_react77.useCallback)(() => {
    if (v.status === "success" && (n2 != null && n2.invalidateOnClose) && m({ id: k, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: c }), H) if (window.confirm(U("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."))) j(false);
    else return;
    F == null || F(void 0), E.close();
  }, [H, v.status]), O = (0, import_react77.useCallback)((R) => {
    typeof R < "u" && (F == null || F(R)), (!(g === "edit" || g === "clone") || (typeof R < "u" || typeof k < "u")) && E.show();
  }, [k]), { visible: M, ...Y } = $, N = { open: M, ...Y };
  return { ...B, ...E, show: O, close: L, open: A, formProps: { ...S, ...B.formProps, onValuesChange: S == null ? void 0 : S.onValuesChange, onKeyUp: S == null ? void 0 : S.onKeyUp, onFinish: async (R) => {
    await T(R), r && K(), s && C.resetFields();
  } }, modalProps: { ...N, width: "1000px", okButtonProps: q2, title: U(`${c}.titles.${a.action}`, `${y(`${a.action} ${((z2 = u == null ? void 0 : u.meta) == null ? void 0 : z2.label) ?? ((w = u == null ? void 0 : u.options) == null ? void 0 : w.label) ?? (u == null ? void 0 : u.label) ?? c}`, "singular")}`), okText: U("buttons.save", "Save"), cancelText: U("buttons.cancel", "Cancel"), onCancel: L, forceRender: true }, formLoading: D };
}, "useModalForm");
var no2 = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  let p = Ae(), [l, m] = import_react78.default.useState(false), { visible: u, show: d, close: c } = TR({ defaultVisible: t }), { resource: f, action: h, identifier: y } = q(a.resource), g = Te(), b = Pe(), P = a.action ?? h ?? "", B = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), C = typeof e2 == "object" && "key" in e2 ? e2.key : f && P && e2 ? `drawer-${(f == null ? void 0 : f.identifier) ?? (f == null ? void 0 : f.name)}-${P}` : void 0, S = he2({ meta: { ...C ? { [C]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: k, formProps: F, formLoading: D, id: T, setId: v, onFinish: U, autoSaveProps: H } = S;
  import_react78.default.useEffect(() => {
    var L, O, M, Y;
    if (l === false && C) {
      let N = (O = (L = g == null ? void 0 : g.params) == null ? void 0 : L[C]) == null ? void 0 : O.open;
      if (typeof N == "boolean" ? N ? d() : c() : typeof N == "string" && N === "true" && d(), B) {
        let z2 = (Y = (M = g == null ? void 0 : g.params) == null ? void 0 : M[C]) == null ? void 0 : Y.id;
        z2 && (v == null || v(z2));
      }
      m(true);
    }
  }, [C, g, B, v, l]), import_react78.default.useEffect(() => {
    var L;
    l === true && (u && C ? b({ query: { [C]: { ...(L = g == null ? void 0 : g.params) == null ? void 0 : L[C], open: true, ...B && T && { id: T } } }, options: { keepQuery: true }, type: "replace" }) : C && !u && b({ query: { [C]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [T, u, d, c, C, B, l]);
  let j = z(), { warnWhen: x, setWarnWhen: K } = vt(), $ = { disabled: D, onClick: () => {
    k.submit();
  }, loading: D }, A = { recordItemId: T, onSuccess: () => {
    v == null || v(void 0), c();
  } }, E = (0, import_react78.useCallback)(() => {
    if (H.status === "success" && (n2 != null && n2.invalidateOnClose) && p({ id: T, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: y }), x) if (window.confirm(j("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."))) K(false);
    else return;
    c(), v == null || v(void 0);
  }, [x]), q2 = (0, import_react78.useCallback)((L) => {
    typeof L < "u" && (v == null || v(L)), (!(P === "edit" || P === "clone") || (typeof L < "u" || typeof T < "u")) && d();
  }, [T]);
  return { ...S, show: q2, close: E, formProps: { form: k, ...S.formProps, onValuesChange: F == null ? void 0 : F.onValuesChange, onKeyUp: F == null ? void 0 : F.onKeyUp, onFinish: async (L) => {
    await U(L), r && c(), s && k.resetFields();
  } }, drawerProps: { width: "500px", onClose: E, open: u, forceRender: true }, saveButtonProps: $, deleteButtonProps: A, formLoading: D };
}, "useDrawerForm");
var ao = o2((e2 = {}) => {
...
var gt = o2(({ onSearch: e2, initialCurrent: t, initialPageSize: r, hasPagination: s = true, pagination: n2, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: l, defaultSetFilterBehavior: m, filters: u, sorters: d, syncWithLocation: c, resource: f, successNotification: h, errorNotification: y, queryOptions: g, liveMode: b, onLiveEvent: P, liveParams: B, meta: C, metaData: S, dataProviderName: k } = {}) => {
  let { tableQueryResult: F, tableQuery: D, current: T, setCurrent: v, pageSize: U, setPageSize: H, filters: j, setFilters: x, sorters: K, setSorters: $, sorter: A, setSorter: E, createLinkForSyncWithLocation: q2, pageCount: L, overtime: O } = IC({ permanentSorter: a, permanentFilter: l, initialCurrent: t, initialPageSize: r, pagination: n2, hasPagination: s, filters: u, sorters: d, initialSorter: i, initialFilter: p, syncWithLocation: c, resource: f, defaultSetFilterBehavior: m, successNotification: h, errorNotification: y, queryOptions: g, liveMode: b, onLiveEvent: P, liveParams: B, meta: I(C, S), metaData: I(C, S), dataProviderName: k }), { syncWithLocation: M } = to(), Y = c ?? M, N = grid_default.useBreakpoint(), [z2] = form_default.useForm(), w = useForm({ form: z2 }), R = sn(b), J = s === false ? "off" : "server", X = ((n2 == null ? void 0 : n2.mode) ?? J) !== "off", se = I(u == null ? void 0 : u.initial, p), { data: _, isFetched: fe, isLoading: Z } = F;
  ...
  let ee = o2((de, te, me) => {
    ...
    var ne;
    let ce = q2({ pagination: { pageSize: U, current: de }, sorters: K, filters: j });
    ...
    return me;
  }, pageSize: U, current: T, simple: !N.sm, position: N.sm ? ["bottomRight"] : ["bottomCenter"], total: _ == null ? void 0 : _.total } : false, "antdPagination");
  return { searchFormProps: { ...w.formProps, onFinish: le }, tableProps: { dataSource: _ == null ? void 0 : _.data, loading: R === "auto" ? Z : !fe, onChange: ee, pagination: ie2(), scroll: { x: true } }, tableQueryResult: F, tableQuery: D, sorters: K, sorter: A, filters: j, setSorters: $, setSorter: E, setFilters: x, current: T, setCurrent: v, pageSize: U, setPageSize: H, pageCount: L, createLinkForSyncWithLocation: q2, overtime: O };
}, "useTable");
...
var mm = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: l, liveMode: m, defaultValue: u, selectedOptionsOrder: d, onLiveEvent: c, liveParams: f, meta: h, metaData: y, dataProviderName: g }) => {
  let { query: b, options: P } = PC({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: l, liveMode: m, defaultValue: u, selectedOptionsOrder: d, onLiveEvent: c, liveParams: f, meta: I(h, y), metaData: I(h, y), dataProviderName: g });
  return { checkboxGroupProps: { options: P, defaultValue: u }, query: b, queryResult: b };
}, "useCheckboxGroup");
var Tm = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: l, liveMode: m, defaultValue: u, selectedOptionsOrder: d, onLiveEvent: c, liveParams: f, meta: h, metaData: y, dataProviderName: g }) => {
  let { query: b, options: P } = PC({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: l, liveMode: m, defaultValue: u, selectedOptionsOrder: d, onLiveEvent: c, liveParams: f, meta: I(h, y), metaData: I(h, y), dataProviderName: g });
  return { radioGroupProps: { options: P, defaultValue: u }, query: b, queryResult: b };
}, "useRadioGroup");
var Cm = o2(({ resource: e2, resourceName: t, mapData: r = o2((u) => u, "mapData"), paparseOptions: s, batchSize: n2 = Number.MAX_SAFE_INTEGER, onFinish: i, meta: a, metaData: p, dataProviderName: l, onProgress: m } = {}) => {
  let u = z(), { resource: d } = q(e2 ?? t), { mutationResult: c, isLoading: f, handleChange: h } = mR({ resource: (d == null ? void 0 : d.identifier) ?? (d == null ? void 0 : d.name), mapData: r, paparseOptions: s, batchSize: n2, meta: I(a, p), metaData: I(a, p), dataProviderName: l, onFinish: i, onProgress: m ?? (({ totalAmount: y, processedAmount: g }) => {
    if (y > 0 && g > 0) {
      let b = import_react81.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react81.default.createElement(progress_default, { type: "circle", percent: Math.floor(g / y * 100), size: 50, strokeColor: "#1890ff", status: "normal" }), import_react81.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, u("notifications.importProgress", { processed: g, total: y }, `Importing: ${g}/${y}`)));
      notification_default.open({ description: b, message: null, key: `${d}-import`, duration: 0 }), g >= y, g === y && setTimeout(() => {
        notification_default.destroy(`${d}-import`);
      }, 4500);
    }
  }) });
  return { uploadProps: { onChange: h, beforeUpload: () => false, showUploadList: false, accept: ".csv" }, buttonProps: { type: "default", loading: f }, mutationResult: c, isLoading: f };
}, "useImport");
var ns = o2(({ resource: e2, initialCurrent: t, initialPageSize: r, pagination: s, hasPagination: n2 = true, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: l, defaultSetFilterBehavior: m, filters: u, sorters: d, onSearch: c, queryOptions: f, syncWithLocation: h, successNotification: y, errorNotification: g, liveMode: b, onLiveEvent: P, liveParams: B, meta: C, metaData: S, dataProviderName: k } = {}) => {
  let { sorters: F, sorter: D, filters: T, current: v, pageSize: U, pageCount: H, setFilters: j, setCurrent: x, setPageSize: K, setSorter: $, setSorters: A, createLinkForSyncWithLocation: E, tableQueryResult: q2, tableQuery: L, overtime: O } = IC({ resource: e2, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: l, filters: u, sorters: d, defaultSetFilterBehavior: m, initialCurrent: t, initialPageSize: r, queryOptions: f, successNotification: y, errorNotification: g, liveMode: b, onLiveEvent: P, liveParams: B, meta: I(C, S), metaData: I(C, S), syncWithLocation: h, dataProviderName: k, pagination: s, hasPagination: n2 }), M = n2 === false ? "off" : "server", Y = ((s == null ? void 0 : s.mode) ?? M) !== "off", N = grid_default.useBreakpoint(), z2 = sn(b), [w] = form_default.useForm(), { data: R, isFetched: J, isLoading: X } = q2, se = o2((Z, ee) => {
    Y && (x(Z), K(ee || 10));
  }, "onChange"), _ = o2(async (Z) => {
    if (c) {
      let ee = await c(Z);
      return Y && (x == null || x(1)), j(ee);
    }
  }, "onFinish"), fe = o2(() => Y ? { itemRender: (Z, ee, le) => {
    var de;
    let ie2 = E({ pagination: { pageSize: U, current: Z }, sorters: F, filters: T });
    ...
    return le;
  }, pageSize: U, current: v, simple: !N.sm, total: R == null ? void 0 : R.total, onChange: se } : false, "antdPagination");
  return { searchFormProps: { form: w, onFinish: _ }, listProps: { dataSource: R == null ? void 0 : R.data, loading: z2 === "auto" ? X : !J, pagination: fe() }, query: L, queryResult: q2, filters: T, setFilters: j, sorter: D, setSorter: $, sorters: F, setSorters: A, current: v, setCurrent: x, pageSize: U, setPageSize: K, pageCount: H, createLinkForSyncWithLocation: E, overtime: O };
}, "useSimpleList");
var Um = o2(() => {
...
var Ct = o2(({ Title: e2, render: t, meta: r }) => {
  let [s, n2] = (0, import_react90.useState)(false), [i, a] = (0, import_react90.useState)(false), p = yo(), l = oe(), m = yt(), { warnWhen: u, setWarnWhen: d } = vt(), { Link: c } = pe(), f = l === "legacy" ? c : m, h = Ta(), y = z(), { menuItems: g, selectedKey: b, defaultOpenKeys: P } = zu({ meta: r }), B = grid_default.useBreakpoint(), { hasDashboard: C } = ge(), S = ie(), { mutate: k } = Mr({ v3LegacyAuthProviderCompatible: !!(S != null && S.isLegacy) }), F = typeof B.lg > "u" ? false : !B.lg, D = e2 ?? h ?? Ft, T = o2((E, q2) => E.map((L) => {
    let { icon: O, label: M, route: Y, key: N, name: z2, children: w, parentName: R, meta: J, options: X } = L;
    if (w.length > 0) return import_react90.default.createElement(Sc, { key: L.key, resource: z2, action: "list", params: { resource: L } }, import_react90.default.createElement(menu_default.SubMenu, { key: L.key, icon: O ?? import_react90.default.createElement(UnorderedListOutlined_default, null), title: M }, T(w, q2)));
    let se = N === q2, _ = !(I(J == null ? void 0 : J.parent, X == null ? void 0 : X.parent, R) !== void 0 && w.length === 0);
    return import_react90.default.createElement(Sc, { key: L.key, resource: z2, action: "list", params: { resource: L } }, import_react90.default.createElement(menu_default.Item, { key: L.key, style: { fontWeight: se ? "bold" : "normal" }, icon: O ?? (_ && import_react90.default.createElement(UnorderedListOutlined_default, null)) }, import_react90.default.createElement(f, { to: Y ?? "" }, M), !s && se && import_react90.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), v = o2(() => {
    u ? window.confirm(y("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (d(false), k()) : k();
  }, "handleLogout"), U = p && import_react90.default.createElement(menu_default.Item, { key: "logout", onClick: v, icon: import_react90.default.createElement(LogoutOutlined_default, null) }, y("buttons.logout", "Logout")), H = C ? import_react90.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: b === "/" ? "bold" : "normal" }, icon: import_react90.default.createElement(DashboardOutlined_default, null) }, import_react90.default.createElement(f, { to: "/" }, y("dashboard.title", "Dashboard")), !s && b === "/" && import_react90.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, j = T(g, b), x = o2(() => t ? t({ dashboard: H, items: j, logout: U, collapsed: s }) : import_react90.default.createElement(import_react90.default.Fragment, null, H, j, U), "renderSider"), K = o2(() => import_react90.default.createElement(import_react90.default.Fragment, null, import_react90.default.createElement(menu_default, { theme: "dark", selectedKeys: b ? [b] : [], defaultOpenKeys: P, mode: "inline", onClick: () => {
    a(false), B.lg || n2(true);
  } }, x())), "renderMenu"), $ = o2(() => import_react90.default.createElement(import_react90.default.Fragment, null, import_react90.default.createElement(drawer_default, { open: i, onClose: () => a(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react90.default.createElement(layout_default, null, import_react90.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react90.default.createElement(D, { collapsed: false }), K()))), import_react90.default.createElement(button_default, { style: To, size: "large", onClick: () => a(true), icon: import_react90.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return import_react90.default.createElement(config_provider_default, { theme: { components: { Menu: { colorItemBg: "transparent", colorItemText: "#fff", colorItemTextSelected: "#fff", colorItemBgSelected: "transparent", colorItemTextHover: "#fff" } } } }, o2(() => F ? $() : import_react90.default.createElement(layout_default.Sider, { collapsible: true, collapsed: s, onCollapse: (E) => n2(E), collapsedWidth: 80, breakpoint: "lg" }, import_react90.default.createElement(D, { collapsed: s }), K()), "renderContent")());
}, "Sider");
var Bt = o2(() => {
...
var Lt = o2(({ Title: e2, render: t, meta: r }) => {
  let { token: s } = theme_default.useToken(), [n2, i] = (0, import_react94.useState)(false), [a, p] = (0, import_react94.useState)(false), l = yo(), m = oe(), u = yt(), { warnWhen: d, setWarnWhen: c } = vt(), { Link: f } = pe(), h = m === "legacy" ? f : u, y = Ta(), g = z(), { menuItems: b, selectedKey: P, defaultOpenKeys: B } = zu({ meta: r }), C = grid_default.useBreakpoint(), { hasDashboard: S } = ge(), k = ie(), { mutate: F } = Mr({ v3LegacyAuthProviderCompatible: !!(k != null && k.isLegacy) }), D = typeof C.lg > "u" ? false : !C.lg, T = e2 ?? y ?? kt, v = o2((E, q2) => E.map((L) => {
    let { icon: O, label: M, route: Y, key: N, name: z2, children: w, parentName: R, meta: J, options: X } = L;
    if (w.length > 0) return import_react94.default.createElement(Sc, { key: L.key, resource: z2, action: "list", params: { resource: L } }, import_react94.default.createElement(menu_default.SubMenu, { key: L.key, icon: O ?? import_react94.default.createElement(UnorderedListOutlined_default, null), title: M }, v(w, q2)));
    let se = N === q2, _ = !(I(J == null ? void 0 : J.parent, X == null ? void 0 : X.parent, R) !== void 0 && w.length === 0);
    return import_react94.default.createElement(Sc, { key: L.key, resource: z2, action: "list", params: { resource: L } }, import_react94.default.createElement(menu_default.Item, { key: L.key, icon: O ?? (_ && import_react94.default.createElement(UnorderedListOutlined_default, null)) }, import_react94.default.createElement(h, { to: Y ?? "" }, M), !n2 && se && import_react94.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), U = o2(() => {
    d ? window.confirm(g("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (c(false), F()) : F();
  }, "handleLogout"), H = l && import_react94.default.createElement(menu_default.Item, { key: "logout", onClick: () => U(), icon: import_react94.default.createElement(LogoutOutlined_default, null) }, g("buttons.logout", "Logout")), j = S ? import_react94.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react94.default.createElement(DashboardOutlined_default, null) }, import_react94.default.createElement(h, { to: "/" }, g("dashboard.title", "Dashboard")), !n2 && P === "/" && import_react94.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, x = v(b, P), K = o2(() => t ? t({ dashboard: j, items: x, logout: H, collapsed: n2 }) : import_react94.default.createElement(import_react94.default.Fragment, null, j, x, H), "renderSider"), $ = o2(() => import_react94.default.createElement(import_react94.default.Fragment, null, import_react94.default.createElement(menu_default, { selectedKeys: P ? [P] : [], defaultOpenKeys: B, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    p(false), C.lg || i(true);
  } }, K())), "renderMenu"), A = o2(() => import_react94.default.createElement(import_react94.default.Fragment, null, import_react94.default.createElement(drawer_default, { open: a, onClose: () => p(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react94.default.createElement(layout_default, null, import_react94.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` } }, import_react94.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated } }, import_react94.default.createElement(T, { collapsed: false })), $()))), import_react94.default.createElement(button_default, { style: ho, size: "large", onClick: () => p(true), icon: import_react94.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return D ? A() : import_react94.default.createElement(layout_default.Sider, { style: { backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` }, collapsible: true, collapsed: n2, onCollapse: (E) => i(E), collapsedWidth: 80, breakpoint: "lg", trigger: import_react94.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: s.colorBgElevated } }, n2 ? import_react94.default.createElement(RightOutlined_default, { style: { color: s.colorPrimary } }) : import_react94.default.createElement(LeftOutlined_default, { style: { color: s.colorPrimary } })) }, import_react94.default.createElement("div", { style: { width: n2 ? "80px" : "200px", padding: n2 ? "0" : "0 16px", display: "flex", justifyContent: n2 ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated, fontSize: "14px" } }, import_react94.default.createElement(T, { collapsed: n2 })), $());
}, "ThemedSider");
var Dt = o2(() => {
...
var Rt = o2(({ Title: e2, render: t, meta: r, fixed: s, activeItemDisabled: n2 = false }) => {
  var Y;
  let { token: i } = theme_default.useToken(), { siderCollapsed: a, setSiderCollapsed: p, mobileSiderOpen: l, setMobileSiderOpen: m } = fo2(), u = yo(), d = (Y = (0, import_react98.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : Y.direction, c = oe(), f = yt(), { warnWhen: h, setWarnWhen: y } = vt(), { Link: g } = pe(), b = c === "legacy" ? g : f, P = Ta(), B = z(), { menuItems: C, selectedKey: S, defaultOpenKeys: k } = zu({ meta: r }), F = grid_default.useBreakpoint(), { hasDashboard: D } = ge(), T = ie(), { mutate: v } = Mr({ v3LegacyAuthProviderCompatible: !!(T != null && T.isLegacy) }), U = typeof F.lg > "u" ? false : !F.lg, H = e2 ?? P ?? be, j = o2((N, z2) => N.map((w) => {
    let { icon: R, label: J, route: X, key: se, name: _, children: fe, parentName: Z, meta: ee, options: le } = w;
    if (fe.length > 0) return import_react98.default.createElement(Sc, { key: w.key, resource: _, action: "list", params: { resource: w } }, import_react98.default.createElement(menu_default.SubMenu, { key: w.key, icon: R ?? import_react98.default.createElement(UnorderedListOutlined_default, null), title: J }, j(fe, z2)));
    let ie2 = se === z2, de = !(I(ee == null ? void 0 : ee.parent, le == null ? void 0 : le.parent, Z) !== void 0 && fe.length === 0), te = n2 && ie2 ? { pointerEvents: "none" } : {};
    return import_react98.default.createElement(Sc, { key: w.key, resource: _, action: "list", params: { resource: w } }, import_react98.default.createElement(menu_default.Item, { key: w.key, icon: R ?? (de && import_react98.default.createElement(UnorderedListOutlined_default, null)), style: te }, import_react98.default.createElement(b, { to: X ?? "", style: te }, J), !a && ie2 && import_react98.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), x = o2(() => {
    h ? window.confirm(B("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (y(false), v()) : v();
  }, "handleLogout"), K = u && import_react98.default.createElement(menu_default.Item, { key: "logout", onClick: () => x(), icon: import_react98.default.createElement(LogoutOutlined_default, null) }, B("buttons.logout", "Logout")), $ = D ? import_react98.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react98.default.createElement(DashboardOutlined_default, null) }, import_react98.default.createElement(b, { to: "/" }, B("dashboard.title", "Dashboard")), !a && S === "/" && import_react98.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, A = j(C, S), E = o2(() => t ? t({ dashboard: $, items: A, logout: K, collapsed: a }) : import_react98.default.createElement(import_react98.default.Fragment, null, $, A, K), "renderSider"), q2 = o2(() => import_react98.default.createElement(menu_default, { selectedKeys: S ? [S] : [], defaultOpenKeys: k, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    m(false);
  } }, E()), "renderMenu"), L = o2(() => import_react98.default.createElement(import_react98.default.Fragment, null, import_react98.default.createElement(drawer_default, { open: l, onClose: () => m(false), placement: d === "rtl" ? "right" : "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react98.default.createElement(layout_default, null, import_react98.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` } }, import_react98.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated } }, import_react98.default.createElement(H, { collapsed: false })), q2()))), import_react98.default.createElement(button_default, { style: vo, size: "large", onClick: () => m(true), icon: import_react98.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (U) return L();
...
var ra = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i, initialSiderCollapsed: a, onSiderCollapsed: p }) => {
  let l = grid_default.useBreakpoint(), m = r ?? Rt, u = t ?? It, d = typeof l.sm > "u" ? true : l.sm, c = !!m({ Title: s });
  return import_react97.default.createElement(xt, { initialSiderCollapsed: a, onSiderCollapsed: p }, import_react97.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: c }, import_react97.default.createElement(m, { Title: s }), import_react97.default.createElement(layout_default, null, import_react97.default.createElement(u, null), import_react97.default.createElement(layout_default.Content, null, import_react97.default.createElement("div", { style: { minHeight: 360, padding: d ? 24 : 12 } }, e2), i && import_react97.default.createElement(i, null)), n2 && import_react97.default.createElement(n2, null))));
}, "ThemedLayoutV2");
...
var Ht2 = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...p }) => {
  let { hidden: l, disabled: m, label: u, title: d, LinkComponent: c, to: f } = qv({ resource: e2 ?? t, meta: n2, accessControl: s }), h = m || p.disabled;
  return l || p.hidden ? null : import_react101.default.createElement(c, { to: f, replace: false, onClick: (g) => {
    if (h) {
      g.preventDefault();
      return;
    }
...
var Ot = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...l }) => {
  let { to: m, label: u, title: d, hidden: c, disabled: f, LinkComponent: h } = Yv({ resource: e2 ?? t, id: r, meta: i, accessControl: n2 }), y = f || l.disabled;
  return c || l.hidden ? null : import_react102.default.createElement(h, { to: m, replace: false, onClick: (b) => {
    if (y) {
      b.preventDefault();
      return;
    }
    p && (b.preventDefault(), p(b));
  } }, import_react102.default.createElement(button_default, { icon: import_react102.default.createElement(EditOutlined_default, null), disabled: y, title: d, className: n.EditButton, ...l }, !s && (a ?? u)));
}, "EditButton");
var Ye = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, onSuccess: s, mutationMode: n2, children: i, successNotification: a, errorNotification: p, hideText: l = false, accessControl: m, metaData: u, meta: d, dataProviderName: c, confirmTitle: f, confirmOkText: h, confirmCancelText: y, invalidates: g, ...b }) => {
  let { title: P, label: B, hidden: C, disabled: S, loading: k, confirmTitle: F, confirmOkLabel: D, cancelLabel: T, onConfirm: v } = qu({ resource: e2 ?? t, id: r, dataProviderName: c, invalidates: g, meta: d, onSuccess: s, mutationMode: n2, errorNotification: p, successNotification: a, accessControl: m }), U = S || b.disabled;
  return C || b.hidden ? null : import_react103.default.createElement(popconfirm_default, { key: "delete", okText: h ?? D, cancelText: y ?? T, okType: "danger", title: f ?? F, okButtonProps: { disabled: k }, onConfirm: v, disabled: U }, import_react103.default.createElement(button_default, { danger: true, loading: k, icon: import_react103.default.createElement(DeleteOutlined_default, null), title: P, disabled: U, className: n.DeleteButton, ...b }, !l && (i ?? B)));
}, "DeleteButton");
...
var Aa = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...l }) => {
  let { to: m, label: u, title: d, hidden: c, disabled: f, LinkComponent: h } = Zv({ resource: e2 ?? t, id: r, accessControl: n2, meta: i }), y = f || l.disabled;
  return c || l.hidden ? null : import_react105.default.createElement(h, { to: m, replace: false, onClick: (b) => {
    if (y) {
      b.preventDefault();
      return;
    }
    p && (b.preventDefault(), p(b));
  } }, import_react105.default.createElement(button_default, { disabled: y, icon: import_react105.default.createElement(EyeOutlined_default, null), title: d, className: n.ShowButton, ...l }, !s && (a ?? u)));
}, "ShowButton");
var Ze = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...p }) => {
  let { to: l, label: m, title: u, hidden: d, disabled: c, LinkComponent: f } = eD({ resource: e2 ?? t, meta: n2, accessControl: s }), h = c || p.disabled;
  return d || p.hidden ? null : import_react106.default.createElement(f, { to: l, replace: false, onClick: (g) => {
    if (h) {
      g.preventDefault();
      return;
    }
...
var ni = o2(({ resourceNameOrRouteName: e2, resource: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...l }) => {
  let { to: m, LinkComponent: u, label: d, disabled: c, hidden: f, title: h } = Jv({ id: r, resource: t ?? e2, accessControl: n2, meta: i }), y = c || l.disabled;
  return f || l.hidden ? null : import_react109.default.createElement(u, { to: m, replace: false, onClick: (b) => {
    if (y) {
      b.preventDefault();
      return;
    }
    p && (b.preventDefault(), p(b));
  } }, import_react109.default.createElement(button_default, { icon: import_react109.default.createElement(PlusSquareOutlined_default, null), disabled: y, title: h, className: n.CloneButton, ...l }, !s && (a ?? d)));
}, "CloneButton");
var mi = o2(({ uploadProps: e2, buttonProps: t, hideText: r = false, children: s, loading: n2 }) => {
  let { label: i } = oD();
  return import_react110.default.createElement(upload_default, { ...e2 }, import_react110.default.createElement(button_default, { icon: import_react110.default.createElement(ImportOutlined_default, null), className: n.ImportButton, loading: n2, ...t }, !r && (s ?? i)));
}, "ImportButton");
var xi = o2(({ canCreate: e2, title: t, children: r, createButtonProps: s, resource: n2, wrapperProps: i, contentProps: a, headerProps: p, breadcrumb: l, headerButtonProps: m, headerButtons: u }) => {
  var S, k;
  let d = z(), { options: { breadcrumb: c } = {} } = ge(), f = oe(), h = ht(), { resource: y, identifier: g } = q(n2), b = e2 ?? (((y == null ? void 0 : y.canCreate) ?? !!(y != null && y.create)) || s), P = typeof l > "u" ? c : l, B = b ? { size: "middle", resource: f === "legacy" ? y == null ? void 0 : y.route : g, ...s } : void 0, C = b ? import_react111.default.createElement(Ht2, { ...B }) : null;
  return import_react111.default.createElement("div", { ...i ?? {} }, import_react111.default.createElement(ke, { title: t ?? d(`${g}.titles.list`, h(((S = y == null ? void 0 : y.meta) == null ? void 0 : S.label) ?? ((k = y == null ? void 0 : y.options) == null ? void 0 : k.label) ?? (y == null ? void 0 : y.label) ?? g, "plural")), extra: u ? import_react111.default.createElement(space_default, { wrap: true, ...m }, typeof u == "function" ? u({ defaultButtons: C, createButtonProps: B }) : u) : C, breadcrumb: typeof P < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, P) ?? void 0 : import_react111.default.createElement(Le, null), ...p ?? {} }, import_react111.default.createElement("div", { ...a ?? {} }, r)));
}, "List");
var Di = o2(({ title: e2, saveButtonProps: t, children: r, resource: s, isLoading: n2 = false, breadcrumb: i, wrapperProps: a, headerProps: p, contentProps: l, headerButtonProps: m, headerButtons: u, footerButtonProps: d, footerButtons: c, goBack: f }) => {
  var v, U;
  let h = z(), { options: { breadcrumb: y } = {} } = ge(), g = oe(), b = Mo(), { goBack: P } = he(), B = ht(), { resource: C, action: S, identifier: k } = q(s), F = typeof i > "u" ? y : i, D = { ...n2 ? { disabled: true } : {}, ...t, htmlType: "submit" }, T = import_react112.default.createElement(import_react112.default.Fragment, null, import_react112.default.createElement(Xe, { ...D }));
  return import_react112.default.createElement("div", { ...a ?? {} }, import_react112.default.createElement(ke, { backIcon: f, onBack: S !== "list" || typeof S < "u" ? g === "legacy" ? P : b : void 0, title: e2 ?? h(`${k}.titles.create`, `Create ${B(((v = C == null ? void 0 : C.meta) == null ? void 0 : v.label) ?? ((U = C == null ? void 0 : C.options) == null ? void 0 : U.label) ?? (C == null ? void 0 : C.label) ?? k, "singular")}`), breadcrumb: typeof F < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, F) ?? void 0 : import_react112.default.createElement(Le, null), extra: import_react112.default.createElement(space_default, { wrap: true, ...m ?? {} }, u ? typeof u == "function" ? u({ defaultButtons: null }) : u : null), ...p ?? {} }, import_react112.default.createElement(spin_default, { spinning: n2 }, import_react112.default.createElement(card_default, { bordered: false, actions: [import_react112.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...d ?? {} }, c ? typeof c == "function" ? c({ defaultButtons: T, saveButtonProps: D }) : c : T)], ...l ?? {} }, r))));
}, "Create");
var zi = o2(({ title: e2, saveButtonProps: t, mutationMode: r, recordItemId: s, children: n2, deleteButtonProps: i, canDelete: a, resource: p, isLoading: l = false, dataProviderName: m, breadcrumb: u, wrapperProps: d, headerProps: c, contentProps: f, headerButtonProps: h, headerButtons: y, footerButtonProps: g, footerButtons: b, goBack: P, autoSaveProps: B }) => {
  var X, se, _;
  let C = z(), { options: { breadcrumb: S } = {} } = ge(), { mutationMode: k } = _e(), F = r ?? k, D = oe(), T = Mo(), v = Pe(), { goBack: U, list: H } = he(), j = ht(), { resource: x, action: K, id: $, identifier: A } = q(p), E = Du({ resource: x, action: "list" }), q2 = s ?? $, L = typeof u > "u" ? S : u, O = (x == null ? void 0 : x.list) && !s, M = a ?? ((((X = x == null ? void 0 : x.meta) == null ? void 0 : X.canDelete) ?? (x == null ? void 0 : x.canDelete)) || i), Y = O ? { ...l ? { disabled: true } : {}, resource: D === "legacy" ? x == null ? void 0 : x.route : A } : void 0, N = { ...l ? { disabled: true } : {}, resource: D === "legacy" ? x == null ? void 0 : x.route : A, recordItemId: q2, dataProviderName: m }, z2 = M ? { ...l ? { disabled: true } : {}, resource: D === "legacy" ? x == null ? void 0 : x.route : A, mutationMode: F, onSuccess: () => {
    D === "legacy" ? H((x == null ? void 0 : x.route) ?? (x == null ? void 0 : x.name) ?? "") : v({ to: E });
  }, recordItemId: q2, dataProviderName: m, ...i } : void 0, w = { ...l ? { disabled: true } : {}, ...t }, R = import_react113.default.createElement(import_react113.default.Fragment, null, B && import_react113.default.createElement(Oo, { ...B }), O && import_react113.default.createElement(Ze, { ...Y }), import_react113.default.createElement(_e2, { ...N })), J = import_react113.default.createElement(import_react113.default.Fragment, null, M && import_react113.default.createElement(Ye, { ...z2 }), import_react113.default.createElement(Xe, { ...w }));
  return import_react113.default.createElement("div", { ...d ?? {} }, import_react113.default.createElement(ke, { backIcon: P, onBack: K !== "list" && typeof K < "u" ? D === "legacy" ? U : T : void 0, title: e2 ?? C(`${A}.titles.edit`, `Edit ${j(((se = x == null ? void 0 : x.meta) == null ? void 0 : se.label) ?? ((_ = x == null ? void 0 : x.options) == null ? void 0 : _.label) ?? (x == null ? void 0 : x.label) ?? A, "singular")}`), extra: import_react113.default.createElement(space_default, { wrap: true, ...h ?? {} }, y ? typeof y == "function" ? y({ defaultButtons: R, listButtonProps: Y, refreshButtonProps: N }) : y : R), breadcrumb: typeof L < "u" ? import_react113.default.createElement(import_react113.default.Fragment, null, L) ?? void 0 : import_react113.default.createElement(Le, null), ...c ?? {} }, import_react113.default.createElement(spin_default, { spinning: l }, import_react113.default.createElement(card_default, { bordered: false, actions: [import_react113.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...g ?? {} }, b ? typeof b == "function" ? b({ defaultButtons: J, deleteButtonProps: z2, saveButtonProps: w }) : b : J)], ...f ?? {} }, n2))));
}, "Edit");
var ep = o2(({ title: e2, canEdit: t, canDelete: r, isLoading: s = false, children: n2, resource: i, recordItemId: a, dataProviderName: p, breadcrumb: l, contentProps: m, headerProps: u, wrapperProps: d, headerButtons: c, footerButtons: f, footerButtonProps: h, headerButtonProps: y, goBack: g }) => {
  var N, z2, w;
  let b = z(), { options: { breadcrumb: P } = {} } = ge(), B = oe(), C = Mo(), S = Pe(), { goBack: k, list: F } = he(), D = ht(), { resource: T, action: v, id: U, identifier: H } = q(i), j = Du({ resource: T, action: "list" }), x = a ?? U, K = typeof l > "u" ? P : l, $ = (T == null ? void 0 : T.list) && !a, A = r ?? ((N = T == null ? void 0 : T.meta) == null ? void 0 : N.canDelete) ?? (T == null ? void 0 : T.canDelete), E = t ?? (T == null ? void 0 : T.canEdit) ?? !!(T != null && T.edit), q2 = $ ? { resource: B === "legacy" ? T == null ? void 0 : T.route : H } : void 0, L = E ? { ...s ? { disabled: true } : {}, type: "primary", resource: B === "legacy" ? T == null ? void 0 : T.route : H, recordItemId: x } : void 0, O = A ? { ...s ? { disabled: true } : {}, resource: B === "legacy" ? T == null ? void 0 : T.route : H, recordItemId: x, onSuccess: () => {
    B === "legacy" ? F((T == null ? void 0 : T.route) ?? (T == null ? void 0 : T.name) ?? "") : S({ to: j });
  }, dataProviderName: p } : void 0, M = { ...s ? { disabled: true } : {}, resource: B === "legacy" ? T == null ? void 0 : T.route : H, recordItemId: x, dataProviderName: p }, Y = import_react114.default.createElement(import_react114.default.Fragment, null, $ && import_react114.default.createElement(Ze, { ...q2 }), E && import_react114.default.createElement(Ot, { ...L }), A && import_react114.default.createElement(Ye, { ...O }), import_react114.default.createElement(_e2, { ...M }));
  return import_react114.default.createElement("div", { ...d ?? {} }, import_react114.default.createElement(ke, { backIcon: g, onBack: v !== "list" && typeof v < "u" ? B === "legacy" ? k : C : void 0, title: e2 ?? b(`${H}.titles.show`, `Show ${D(((z2 = T == null ? void 0 : T.meta) == null ? void 0 : z2.label) ?? ((w = T == null ? void 0 : T.options) == null ? void 0 : w.label) ?? (T == null ? void 0 : T.label) ?? H, "singular")}`), extra: import_react114.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...y ?? {} }, c ? typeof c == "function" ? c({ defaultButtons: Y, deleteButtonProps: O, editButtonProps: L, listButtonProps: q2, refreshButtonProps: M }) : c : Y), breadcrumb: typeof K < "u" ? import_react114.default.createElement(import_react114.default.Fragment, null, K) ?? void 0 : import_react114.default.createElement(Le, null), ...u ?? {} }, import_react114.default.createElement(spin_default, { spinning: s }, import_react114.default.createElement(card_default, { bordered: false, actions: f ? [import_react114.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...h }, typeof f == "function" ? f({ defaultButtons: null }) : f)] : void 0, ...m ?? {} }, n2))));
}, "Show");
...
var Hp = o2((e2) => {
  let { setSelectedKeys: t, confirm: r, clearFilters: s, mapValue: n2 = o2((c) => c, "mapValue"), selectedKeys: i, children: a } = e2, p = z(), l = o2(() => {
    s && s();
  }, "clearFilter"), m = o2(() => {
    let c;
    typeof i == "number" ? c = `${i}` : import_dayjs6.default.isDayjs(i) ? c = [i.toISOString()] : c = i, t(c), r == null || r();
  }, "onFilter"), u = o2((c) => {
    if (typeof c == "object") {
      if (Array.isArray(c)) {
        let b = n2(c, "onChange");
      ...
      let h = !c || !c.target || import_dayjs6.default.isDayjs(c) ? { target: { value: c } } : c, { target: y } = h, g = n2(y.value, "onChange");
      t(g);
      return;
    }
    let f = n2(c, "onChange");
    t(f);
  }, "onChange"), d = import_react125.default.Children.map(a, (c) => import_react125.default.isValidElement(c) ? import_react125.default.cloneElement(c, { onChange: u, value: n2(i, "value") }) : c);
...
var $t = o2(({ providers: e2, registerLink: t, forgotPasswordLink: r, rememberMe: s, contentProps: n2, wrapperProps: i, renderContent: a, formProps: p, title: l, hideForm: m, mutationVariables: u }) => {
  let { token: d } = theme_default.useToken(), [c] = form_default.useForm(), f = z(), h = oe(), y = yt(), { Link: g } = pe(), b = h === "legacy" ? g : y, P = ie(), { mutate: B, isLoading: C } = Ht({ v3LegacyAuthProviderCompatible: !!(P != null && P.isLegacy) }), S = l === false ? null : import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, l ?? import_react130.default.createElement(be, { collapsed: false })), k = import_react130.default.createElement(typography_default.Title, { level: 3, style: { color: d.colorPrimaryTextHover, ...Ie } }, f("pages.login.title", "Sign in to your account")), F = o2(() => e2 && e2.length > 0 ? import_react130.default.createElement(import_react130.default.Fragment, null, e2.map((T) => import_react130.default.createElement(button_default, { key: T.name, type: "default", block: true, icon: T.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => B({ ...u, providerName: T.name }) }, T.label)), !m && import_react130.default.createElement(divider_default, null, import_react130.default.createElement(typography_default.Text, { style: { color: d.colorTextLabel } }, f("pages.login.divider", "or")))) : null, "renderProviders"), D = import_react130.default.createElement(card_default, { title: k, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: d.colorBgElevated }, ...n2 ?? {} }, F(), !m && import_react130.default.createElement(form_default, { layout: "vertical", form: c, onFinish: (T) => B({ ...T, ...u }), requiredMark: false, initialValues: { remember: false }, ...p }, import_react130.default.createElement(form_default.Item, { name: "email", label: f("pages.login.fields.email", "Email"), rules: [{ required: true, message: f("pages.login.errors.requiredEmail", "Email is required") }, { type: "email", message: f("pages.login.errors.validEmail", "Invalid email address") }] }, import_react130.default.createElement(input_default, { size: "large", placeholder: f("pages.login.fields.email", "Email") })), import_react130.default.createElement(form_default.Item, { name: "password", label: f("pages.login.fields.password", "Password"), rules: [{ required: true, message: f("pages.login.errors.requiredPassword", "Password is required") }] }, import_react130.default.createElement(input_default, { type: "password", autoComplete: "current-password", placeholder: "●●●●●●●●", size: "large" })), import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, s ?? import_react130.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react130.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, f("pages.login.buttons.rememberMe", "Remember me"))), r ?? import_react130.default.createElement(b, { style: { color: d.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, f("pages.login.buttons.forgotPassword", "Forgot password?"))), !m && import_react130.default.createElement(form_default.Item, null, import_react130.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: C, block: true }, f("pages.login.signin", "Sign in")))), t ?? import_react130.default.createElement("div", { style: { marginTop: m ? 16 : 8 } }, import_react130.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, f("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react130.default.createElement(b, { to: "/register", style: { fontWeight: "bold", color: d.colorPrimaryTextHover } }, f("pages.login.signup", "Sign up")))));
  return import_react130.default.createElement(layout_default, { style: De, ...i ?? {} }, import_react130.default.createElement(row_default, { justify: "center", align: m ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: m ? "15dvh" : "16px" } }, import_react130.default.createElement(col_default, { xs: 22 }, a ? a(D, S) : import_react130.default.createElement(import_react130.default.Fragment, null, S, D))));
}, "LoginPage");
var Yt = o2(({ providers: e2, loginLink: t, wrapperProps: r, contentProps: s, renderContent: n2, formProps: i, title: a, hideForm: p, mutationVariables: l }) => {
  let { token: m } = theme_default.useToken(), [u] = form_default.useForm(), d = z(), c = oe(), f = yt(), { Link: h } = pe(), y = c === "legacy" ? h : f, g = ie(), { mutate: b, isLoading: P } = co({ v3LegacyAuthProviderCompatible: !!(g != null && g.isLegacy) }), B = a === false ? null : import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, a ?? import_react131.default.createElement(be, { collapsed: false })), C = import_react131.default.createElement(typography_default.Title, { level: 3, style: { color: m.colorPrimaryTextHover, ...Ie } }, d("pages.register.title", "Sign up for your account")), S = o2(() => e2 && e2.length > 0 ? import_react131.default.createElement(import_react131.default.Fragment, null, e2.map((F) => import_react131.default.createElement(button_default, { key: F.name, type: "default", block: true, icon: F.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => b({ ...l, providerName: F.name }) }, F.label)), !p && import_react131.default.createElement(divider_default, null, import_react131.default.createElement(typography_default.Text, { style: { color: m.colorTextLabel } }, d("pages.register.divider", d("pages.login.divider", "or"))))) : null, "renderProviders"), k = import_react131.default.createElement(card_default, { title: C, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: m.colorBgElevated }, ...s ?? {} }, S(), !p && import_react131.default.createElement(form_default, { layout: "vertical", form: u, onFinish: (F) => b({ ...l, ...F }), requiredMark: false, ...i }, import_react131.default.createElement(form_default.Item, { name: "email", label: d("pages.register.email", "Email"), rules: [{ required: true, message: d("pages.register.errors.requiredEmail", "Email is required") }, { type: "email", message: d("pages.register.errors.validEmail", "Invalid email address") }] }, import_react131.default.createElement(input_default, { size: "large", placeholder: d("pages.register.fields.email", "Email") })), import_react131.default.createElement(form_default.Item, { name: "password", label: d("pages.register.fields.password", "Password"), rules: [{ required: true, message: d("pages.register.errors.requiredPassword", "Password is required") }] }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, t ?? import_react131.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, d("pages.register.buttons.haveAccount", d("pages.login.buttons.haveAccount", "Have an account?")), " ", import_react131.default.createElement(y, { style: { fontWeight: "bold", color: m.colorPrimaryTextHover }, to: "/login" }, d("pages.register.signin", d("pages.login.signin", "Sign in"))))), import_react131.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react131.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: P, block: true }, d("pages.register.buttons.submit", "Sign up")))), p && t !== false && import_react131.default.createElement("div", { style: { marginTop: p ? 16 : 8 } }, import_react131.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, d("pages.register.buttons.haveAccount", d("pages.login.buttons.haveAccount", "Have an account?")), " ", import_react131.default.createElement(y, { style: { fontWeight: "bold", color: m.colorPrimaryTextHover }, to: "/login" }, d("pages.register.signin", d("pages.login.signin", "Sign in"))))));
  return import_react131.default.createElement(layout_default, { style: De, ...r ?? {} }, import_react131.default.createElement(row_default, { justify: "center", align: p ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: p ? "15dvh" : "16px" } }, import_react131.default.createElement(col_default, { xs: 22 }, n2 ? n2(k, B) : import_react131.default.createElement(import_react131.default.Fragment, null, B, k))));
}, "RegisterPage");
var _t = o2(({ loginLink: e2, wrapperProps: t, contentProps: r, renderContent: s, formProps: n2, title: i, mutationVariables: a }) => {
  let { token: p } = theme_default.useToken(), [l] = form_default.useForm(), m = z(), u = oe(), d = yt(), { Link: c } = pe(), f = u === "legacy" ? c : d, { mutate: h, isLoading: y } = lo(), g = i === false ? null : import_react132.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, i ?? import_react132.default.createElement(be, { collapsed: false })), b = import_react132.default.createElement(typography_default.Title, { level: 3, style: { color: p.colorPrimaryTextHover, ...Ie } }, m("pages.forgotPassword.title", "Forgot your password?")), P = import_react132.default.createElement(card_default, { title: b, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: p.colorBgElevated }, ...r ?? {} }, import_react132.default.createElement(form_default, { layout: "vertical", form: l, onFinish: (B) => h({ ...B, ...a }), requiredMark: false, ...n2 }, import_react132.default.createElement(form_default.Item, { name: "email", label: m("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true, message: m("pages.forgotPassword.errors.requiredEmail", "Email is required") }, { type: "email", message: m("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react132.default.createElement(input_default, { type: "email", size: "large", placeholder: m("pages.forgotPassword.fields.email", "Email") })), import_react132.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react132.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, m("pages.forgotPassword.buttons.haveAccount", m("pages.register.buttons.haveAccount", "Have an account? ")), " ", import_react132.default.createElement(f, { style: { fontWeight: "bold", color: p.colorPrimaryTextHover }, to: "/login" }, m("pages.forgotPassword.signin", m("pages.login.signin", "Sign in"))))), import_react132.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react132.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: y, block: true }, m("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react132.default.createElement(layout_default, { style: De, ...t ?? {} }, import_react132.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react132.default.createElement(col_default, { xs: 22 }, s ? s(P, g) : import_react132.default.createElement(import_react132.default.Fragment, null, g, P))));
}, "ForgotPasswordPage");
var Zt = o2(({ wrapperProps: e2, contentProps: t, renderContent: r, formProps: s, title: n2, mutationVariables: i }) => {
  let { token: a } = theme_default.useToken(), [p] = form_default.useForm(), l = z(), m = ie(), { mutate: u, isLoading: d } = fo({ v3LegacyAuthProviderCompatible: !!(m != null && m.isLegacy) }), c = n2 === false ? null : import_react133.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, n2 ?? import_react133.default.createElement(be, { collapsed: false })), f = import_react133.default.createElement(typography_default.Title, { level: 3, style: { color: a.colorPrimaryTextHover, ...Ie } }, l("pages.updatePassword.title", "Set New Password")), h = import_react133.default.createElement(card_default, { title: f, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: a.colorBgElevated }, ...t ?? {} }, import_react133.default.createElement(form_default, { layout: "vertical", form: p, onFinish: (y) => u({ ...y, ...i }), requiredMark: false, ...s }, import_react133.default.createElement(form_default.Item, { name: "password", label: l("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true, message: l("pages.updatePassword.errors.requiredPassword", "Password is required") }], style: { marginBottom: "12px" } }, import_react133.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react133.default.createElement(form_default.Item, { name: "confirmPassword", label: l("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true, message: l("pages.updatePassword.errors.requiredConfirmPassword", "Confirm password is required") }, ({ getFieldValue: y }) => ({ validator(g, b) {
    return !b || y("password") === b ? Promise.resolve() : Promise.reject(new Error(l("pages.updatePassword.errors.confirmPasswordNotMatch", "Passwords do not match")));
  ...
  return import_react133.default.createElement(layout_default, { style: De, ...e2 ?? {} }, import_react133.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react133.default.createElement(col_default, { xs: 22 }, r ? r(h, c) : import_react133.default.createElement(import_react133.default.Fragment, null, c, h))));
}, "UpdatePasswordPage");
var dd = o2((e2) => {
  let { type: t } = e2;
...
var Le = o2(({ breadcrumbProps: e2, showHome: t = true, hideIcons: r = false, meta: s, minItems: n2 = 2 }) => {
  let i = oe(), { breadcrumbs: a } = fb({ meta: s }), p = yt(), { Link: l } = pe(), { hasDashboard: m } = ge(), { resources: u } = q(), d = as("/", u), c = i === "legacy" ? l : p;
  if (a.length < n2) return null;
  let f = a.map(({ label: y, icon: g, href: b }) => ({ key: `breadcrumb-item-${y}`, title: import_react134.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, !r && g, b ? import_react134.default.createElement(c, { to: b }, y) : import_react134.default.createElement("span", null, y)) }));
  return import_react134.default.createElement(breadcrumb_default, { items: o2(() => {
    var y, g;
    return t && (m || d.found) ? [{ key: "breadcrumb-item-home", title: import_react134.default.createElement(c, { to: "/" }, ((g = (y = d == null ? void 0 : d.resource) == null ? void 0 : y.meta) == null ? void 0 : g.icon) ?? import_react134.default.createElement(HomeOutlined_default, null)) }, ...f] : f;
